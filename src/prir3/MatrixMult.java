...
public class MatrixMult {
    ...
    protected void start(String[] args) throws FileNotFoundException {
        Matrix A,B;
        A = read("C:\\Users\\dell\\IdeaProjects\\untitled13\\src\\prir3\\A.txt");
        B = read("C:\\Users\\dell\\IdeaProjects\\untitled13\\src\\prir3\\B.txt");
       // A = read("A.txt");
       // B = read("B.txt");
        ...
        for(int i=0;i<A.rows();i++){
            ThreadDemo watek = new ThreadDemo( "Thread-"+i,i,A,B,C);
            watek.start();
            //watek.run();
            try {
                watek.join();
